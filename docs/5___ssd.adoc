...
{empty}[ _An SSP may contain nested SSP files that conform to different SSP versions.
Tools can safely load SSP files using the latest supported version due to backward compatibility._ ]
