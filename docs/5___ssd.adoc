...
For specification of system architecture, local variables may be defined with `kind="local"`.
...
image:images/image27.png[image,width=382,height=524]
...
When SSP is used for specification of a system architecture, connectors of kind `local` are used to define local variables of the system. Such a local variable *MUST NOT* be used for connections.
