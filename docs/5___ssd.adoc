...
image:images/SystemStructureDescription_SystemStructureDescription.svg[image]
...
image:images/SystemStructureDescription_DefaultExperiment.svg[image]
...
image:images/SystemStructureDescription_TElement.svg[image]
...
image:images/SystemStructureDescription_Connectors.svg[image]
...
image:images/SystemStructureDescription_Connector.svg[image]
...
{empty}[ _Note: The element name Clock is used for two different child elements in the Connector context._
_In the type choice, Clock refers to the SystemStructureCommon element `ssc:Clock` (the connector type)._
_The additional Clock child element with attribute `name` refers to the SystemStructureDescription element `ssd:Clock` (the connector-to-clock association)._ ]
...
image:images/SystemStructureDescription_ConnectorGeometry.svg[image]
...
image:images/Example_ConnectorGeometry.svg[image] +
]

==== ElementGeometry

image:images/SystemStructureDescription_ElementGeometry.svg[image]
...
image:images/Example_ElementGeometry.svg[image] +
]
...
image:images/Example_Icon0.svg[image]

__**Example 1: No flip** (__x1__<__x2__, __y1__<__y2__), __rotation__=**0** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**true**, __iconFlip__=**IGNORED** (relevant only if element is flipped)__

image:images/Example_Icon1.svg[image]

__**Example 2: No flip** (__x1__<__x2__, __y1__<__y2__), __rotation__=**0** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**false**, __iconFlip__=**IGNORED**__

image:images/Example_Icon2.svg[image]

__**Example 3: No flip** (__x1__<__x2__, __y1__<__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**true**, __iconFlip__=**IGNORED**__

image:images/Example_Icon3.svg[image]

__**Example 4: No flip** (__x1__<__x2__, __y1__<__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**false**, __iconFlip__=**IGNORED**__

image:images/Example_Icon4.svg[image]

__**Example 5: No flip** (__x1__<__x2__, __y1__<__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**true**, __iconFlip__=**IGNORED**__

image:images/Example_Icon5.svg[image]

__**Example 6: No flip** (__x1__<__x2__, __y1__<__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**false**, __iconFlip__=**IGNORED**__

image:images/Example_Icon6.svg[image]

__**Example 7: Horizontal flip** (__x1__>__x2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**true**, __iconFlip__=**true**__

image:images/Example_Icon7.svg[image]

__**Example 8: Horizontal flip** (__x1__>__x2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**false**, __iconFlip__=**false**__

image:images/Example_Icon8.svg[image]

__**Example 9: Horizontal flip** (__x1__>__x2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**true**, __iconFlip__=**false**__

image:images/Example_Icon9.svg[image]

__**Example 10: Vertical flip** (__y1__>__y2__), __rotation__=**0** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**true**, __iconFlip__=**false**__

image:images/Example_Icon10.svg[image]

__**Example 11: Horizontal and vertical flip** (__x1__>__x2__, __y1__>__y2__), __rotation__=**0** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**true**, __iconFlip__=**false**__

image:images/Example_Icon11.svg[image]

__**Example 12: Horizontal and vertical flip** (__x1__>__x2__, __y1__>__y2__), __rotation__=**0** +
__iconRotation__=**0**, __iconFixedAspectRatio__=**true**, __iconFlip__=**true**__

image:images/Example_Icon12.svg[image]

__**Example 13: Horizontal and vertical flip** (__x1__>__x2__, __y1__>__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**true**, __iconFlip__=**true**__

image:images/Example_Icon13.svg[image]

__**Example 14: Horizontal and vertical flip** (__x1__>__x2__, __y1__>__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**false**, __iconFlip__=**true**__

image:images/Example_Icon14.svg[image]

__**Example 15: Horizontal and vertical flip** (__x1__>__x2__, __y1__>__y2__), __rotation__=**&#x03C6;** +
__iconRotation__=**&#x03C6;**, __iconFixedAspectRatio__=**true**, __iconFlip__=**false**__

image:images/Example_Icon15.svg[image]

]

==== ParameterBindings

image:images/SystemStructureDescription_ParameterBindings.svg[image]
...
image:images/SystemStructureDescription_ParameterValues.svg[image]
...
image:images/SystemStructureDescription_ParameterMapping.svg[image]
...
image:images/SystemStructureDescription_System.svg[image]
...
image:images/SystemStructureDescription_Elements.svg[image]
...
image:images/SystemStructureDescription_Connections.svg[image]
...
image:images/SystemStructureDescription_Connection.svg[image]
...
image:images/SystemStructureDescription_ConnectionGeometry.svg[image]
...
image:images/Example_ConnectionGeometry.svg[image] +
]
...
image:images/SystemStructureDescription_SignalDictionaries.svg[image]

This optional element provides the set of defined signal dictionaries for the system.

image:images/SystemStructureDescription_SignalDictionary.svg[image]
...
image:images/SystemStructureDescription_SystemGeometry.svg[image]
...
_Subsystem A is an element with an ElementGeometry (latexmath:[x_{1AE}, y_{1AE}, x_{2AE}, y_{2AE}]) and a SystemGeometry (latexmath:[x_{1AS}, y_{1AS}, x_{2AS}, y_{2AS}])._

_B is an element in subystem A with an ElementGeometry coordinates (latexmath:[x_{1BE}, y_{1BE}, x_{2BE}, y_{2BE}])._

image:images/Example_NestedElementGeometry.svg[image]

_To plot the element B in the system where A is located, use the following coordinate transformation:_

latexmath:[x_{1BE} \rightarrow x_{1AE} + (x_{1BE} - x_{1AS}) \cdot \frac{x_{2AE} - x_{1AE}}{x_{2AS} - x_{1AS}}]

latexmath:[y_{1BE} \rightarrow y_{1AE} + (y_{1BE} - y_{1AS}) \cdot \frac{y_{2AE} - y_{1AE}}{y_{2AS} - y_{1AS}}]

latexmath:[x_{2BE} \rightarrow x_{2AE} + (x_{2BE} - x_{1AS}) \cdot \frac{x_{2AE} - x_{1AE}}{x_{2AS} - x_{1AS}}]

latexmath:[y_{2BE} \rightarrow y_{2AE} + (y_{2BE} - y_{1AS}) \cdot \frac{y_{2AE} - y_{1AE}}{y_{2AS} - y_{1AS}}] ]

==== GraphicalElements

image:images/SystemStructureDescription_GraphicalElements.svg[image]
...
image:images/SystemStructureDescription_Note.svg[image]
...
|x2 |Required attribute giving the x coordinate of the upper-right corner of the note, x1 < x2.
|y2 |Required attribute giving the y coordinate of the upper-right corner of the note, y1 < y2.
|===

=== Component

image:images/SystemStructureDescription_Component.svg[image]
...
image:images/SystemStructureDescription_SignalDictionaryReference.svg[image]
