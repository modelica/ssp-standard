...
* The media type is "text/x-modelica" and the "type" attribute designates the path of the Modleica connector..
...
For type text/x-modelica, an additional attribute _path_ specifies the full path of the Modelica class.
