...
image:images/SystemStructureParameterValues_ParameterSet.png[]
...
|version
|This required attribute specifies the version of this specification that the parameter set conforms to.
...
|Parameters
|This required element specifies the parameters in the parameter set.
See below for details.

|Enumerations
|This optional element must contain definitions for all enumerations referenced in the parameter set.
See <<Enumerations>> for its definition.

|Units
|This optional element must contain definitions for all units referenced in the parameter set.
...
|name
|This required attribute specifies the name of the parameter in the parameter set.
...
|Exactly one of these elements must be present to specify the type of the parameter.
See below for details on each type.

|Dimension
|One or more of these optional elements specify the parameter array dimensions, making the parameter an array parameter.
...
|unit
|This optional attribute gives the name of the unit of the parameter.
...
|value
|This required attribute specifies the value of the parameter as the enumeration item name.
