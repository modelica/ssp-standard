...
image:images/SystemStructureParameterValues_ParameterSet.svg[image]
...
image:images/SystemStructureParameterValues_Parameters.svg[image]
...
image:images/SystemStructureParameterValues_Parameter.svg[image]
...
image:images/SystemStructureParameterValues_Real.svg[image]
...
image:images/SystemStructureParameterValues_Float64.svg[image]
...
image:images/SystemStructureParameterValues_Float32.svg[image]
...
image:images/SystemStructureParameterValues_Integer.svg[image]
...
image:images/SystemStructureParameterValues_Int8.svg[image]
...
image:images/SystemStructureParameterValues_UInt8.svg[image]
...
image:images/SystemStructureParameterValues_Int16.svg[image]
...
image:images/SystemStructureParameterValues_UInt16.svg[image]
...
image:images/SystemStructureParameterValues_Int32.svg[image]
...
image:images/SystemStructureParameterValues_UInt32.svg[image]
...
image:images/SystemStructureParameterValues_Int64.svg[image]
...
image:images/SystemStructureParameterValues_UInt64.svg[image]
...
image:images/SystemStructureParameterValues_Boolean.svg[image]
...
image:images/SystemStructureParameterValues_String.svg[image]
...
image:images/SystemStructureParameterValues_Enumeration.svg[image]
...
NOTE: Note: the level of consistency checking is left optional by design, since mandating consistency checking across files requires unified types across files coming potentially from different sources, which is not always realistically possible.
|===
...
image:images/SystemStructureParameterValues_Binary.svg[image]
