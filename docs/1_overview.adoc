...
This section introduces the basic properties and guiding principles that underlie the design of the SSP standard:
...
* Support for FMI 3.0
  ** Support for the new basic data types: Float{32|64}, and [U]Int{8|16|32|64}.
...
* General clarifications and bug fixes
  ** Fix missing type of Connector name attribute (in PR #4)
  ** Clarify type conversion handling (PR #21)
  ** Clarify uniqueness of root SSDs (PR #23)
  ** Clarify hierarchical parameter name resolution (PR #27)
