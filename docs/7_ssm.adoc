...
image:images/SystemStructureParameterMapping_ParameterMapping.png[]
...
|target
|This required attribute specifies the name of the parameter in the system or component that is to be parameterized, i.e. that is the target of this mapping entry.
...
|Specifies an optional transformation for the mapping.
