...
SSP can be seen as an extension to the FMI (Functional Mock-up Interface) standard <<FMI30>>.
...
Tool independence:: The core intent of SSP is to enable the exchange of partial and complete simulation systems between tools.
...
Simplicity:: SSP is focused on the possibility to exchange complete or partial topologies and parameters between different tools as simply as possible, while retaining essential information.
...
Maximum Reuseability:: SSP contributes to maximizing reusability of models and parameters across tools and use cases.
...
* General clarifications and bug fixes
  ** Fix missing type of Connector name attribute in https://github.com/modelica/ssp-standard/pull/4[PR #4]
  ** Clarify type conversion handling in https://github.com/modelica/ssp-standard/pull/21[PR #21]
  ** Clarify uniqueness of root SSDs in https://github.com/modelica/ssp-standard/pull/23[PR #23]
  ** Clarify hierarchical parameter name resolution in https://github.com/modelica/ssp-standard/pull/27[PR #27]
