...
Additional common data for use across tools can also be standardized as layered standards (cf. section 2.2).
...
If the system has global parameters that shall be propagated to multipile components, the definition can also be made at system level.
