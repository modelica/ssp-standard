...
|===
|Element |Description
|Dimension |One or more instances of this element *CAN* be present to specify the dimensions of the containing model element. If no instances are present, the containing model element is scalar. See below for details.
|===
