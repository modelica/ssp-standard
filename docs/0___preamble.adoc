...
Copyright &copy; 2016-2025 Modelica Association Project "SSP"
...
The legal license text and disclaimer is available at http://creativecommons.org/licenses/by-sa/4.0/legalcode.
