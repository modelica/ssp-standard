...
{empty}[ _For example, an SSP 2.0 package may contain:_

* _An SSD file conforming to SSP 2.0_
* _Parameter sets (SSV files) where some conform to SSP 1.0 and others to SSP 2.0_
* _FMUs conforming to FMI 2.0, FMI 3.0, or both_
* _Nested SSP packages conforming to SSP 1.0_ ]
